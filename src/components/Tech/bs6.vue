               ...
               async getData() {
                 ...
                 try {
                   const response = await fetch(
                    ` https://api-epicnews404.azurewebsites.net/Articles?SiteId=1&WithImageOnly=true&WithContentOnly=true&Tags=Technology&Page=1&PageSize=${pageSize}`
                   );
      ...
      <template lang="">
        <div class="mb-3 ">
          <div class="section-title mb-0">
            <h4 class="m-0 font-weight-bold">Technology Articles</h4>
          </div>
          <div class="card-body">
          <div
