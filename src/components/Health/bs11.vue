<template lang="">
    <div class="mb-3"
    v-for="(item, index) in articles.slice(60)" :key="index"
    ...
    >
                        ...
                        <div class="bg-white text-center   p-3">
                              ...
                              <img class="img-fluid " v-if = "item.urlToImage" :src="item.urlToImage" style="object-fit: cover;">
                                    <img class="img-fluid " v-else src="https://healthnews-stat.com/wp-content/uploads/2023/03/97925489.jpg" style="object-fit: cover;">
