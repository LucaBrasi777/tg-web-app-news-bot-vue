  ...
  <div class="container-fluid" style="margin-top:10px">
     ...
     <div class="col-lg-5 px-0">
              <div class="row mx-0">
                  ...
                  v-for="(item, index) in articles.slice(67)" :key="index"
          ...
          v-for="(item, index) in articles2.slice(71)" :key="index"
          >
...
export default {
  data() {
      return {
        ...
        image2:'https://www.sesankareem.com.ng/wp-content/uploads/2017/01/Health.jpg',
        articles: [],
        articles2: [],
        currentPage: 1,    
        totalPages: 1,    
    ...
    methods: {
        ...
        async getData() {
          ...
          try {
            const response = await fetch(
              `https://api-epicnews404.azurewebsites.net/Articles/TopHeadlines?SiteId=6&CategoryId=11&Language=14&WithImageOnly=true&Page=1&PageSize=${pageSize}`
            );
        ...
        async getData2() {
          ...
          try {
            const response = await fetch(
              `https://api-epicnews404.azurewebsites.net/Articles/TopHeadlines?SiteId=1&CategoryId=8&Language=14&WithImageOnly=true&Page=1&PageSize=${pageSize}`
            );
            const data = await response.json();
            return data.items;
          } catch (error) {
