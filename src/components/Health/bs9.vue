<template lang="">
            ...
            <div class="col-lg-12 px-0">
                <div class="row mx-0">
                    ...
                    v-for="(item, index) in articles.slice(39)" :key="index">
...
<!--        
  ...
  export default {
    data() {
        return {
          image:"https://imageio.forbes.com/specials-images/imageserve/638ee3f77ab30981d50d997c/0x0.jpg?format=jpg&height=900&width=1600&fit=bounds",
          articles: [],
          articles2: [],
          currentPage: 1,    
          totalPages: 1,    
      ...
      methods: {
          ...
          async getData2() {
            ...
            try {
              const response = await fetch(
                `https://api-epicnews404.azurewebsites.net/Articles/TopHeadlines?SiteId=1&CategoryId=8&Language=14&Page=2&PageSize=${pageSize}`
              );
              const data = await response.json();
              return data.items;
            } catch (error) {
