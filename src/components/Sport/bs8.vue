<template lang="">
    ...
    <div class="container-fluid" style="margin-top:10px">
        <div class="row">
           <div class="col-lg-7 px-0"
            v-for="(item,index) in articles2.slice(48)"
                    :key="item"
            >
            ...
            <div class="col-lg-5 px-0">
                <div class="row mx-0">
                    ...
                    v-for="(item, index) in articles.slice(49)" :key="item">
  ...
  export default {
    data() {
        return {
          image2:'https://nzsportcollective.co.nz/wp-content/uploads/2023/05/NZSCC-montage.jpg',
          image:'https://dovidka.biz.ua/wp-content/uploads/2015/12/tsikavi-fakty-pro-sport.jpg',
          articles: [],
          articles2: [], 
          currentPage: 1,    
          totalPages: 1,
          ...
          async getData() {
            ...
            try {
              const response = await fetch(
                `https://api-epicnews404.azurewebsites.net/Articles/TopHeadlines?SiteId=3&CategoryId=10&Language=14&Page=1&PageSize=${pageSize}`
              );
