<template lang="">
       ...
       <div class="col-lg-12 px-0">
                <div class="row mx-0">
                    ...
                    v-for="(item, index) in articles2.slice(57)" :key="index"
  ...
  export default {
    data() {
        return {
          image:'https://rivercityrecbowling.net/wp-content/uploads/2022/01/20180728-The18-Image-Most-Popular-Sports2.jpg',
          articles: [],
          articles2: [], 
          currentPage: 1,    
          totalPages: 1,    
