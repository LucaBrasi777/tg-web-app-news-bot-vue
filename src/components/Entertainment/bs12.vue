<template lang="">
    ...
    <div class="container-fluid" style="margin-top:10px">
       ...
       <div class="col-lg-5 px-0">
                <div class="row mx-0">
                    ...
                    v-for="(item, index) in articles.slice(36)" :key="index"
            ...
            v-for="(item, index) in articles2.slice(40)" :key="index"
            >
  ...
  export default {
    data() {
        return {
          image:'https://media.moddb.com/images/games/1/46/45829/City_01B.png',
          image2:'https://www.popoptiq.com/wp-content/uploads/2019/01/1-26-1.jpg',
          articles: [],
          articles2: [], 
          currentPage: 1,   
          totalPages: 1,    
