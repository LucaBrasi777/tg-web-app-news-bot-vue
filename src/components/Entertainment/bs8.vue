<template lang="">
    ...
    <div class="container-fluid" style="margin-top:10px">
        <div class="row">
            ...
            v-for="(item,index) in articles2.slice(36)"
                    :key="index"
            >
            ...
            <div class="col-lg-5 px-0">
                <div class="row mx-0">
                    ...
                    v-for="(item, index) in articles.slice(37)" :key="item">
  ...
  export default {
    data() {
        return {
          image:'https://images.livemint.com/img/2022/06/23/1600x900/indian_media_and_entertainment_1655983505312_1655983505493.jpg',
          image2:'https://www.livenationentertainment.com/wp-content/uploads/2019/01/1200x500px-02FINAL.jpg',
          articles: [],
          articles2: [], 
          currentPage: 1,   
          totalPages: 1,     
