...
export default {
  ...
  mounted() {
    axios
      .get('https://newsapi.org/v2/top-headlines?category=health&language=en&apiKey=3b78f002dbc4466fb5314c295e5f268b&pageSize=1')
...
hr{
  background-color: rgb(7, 218, 250);
  height: 4px;
}
h2 {
  // text-align: center;
