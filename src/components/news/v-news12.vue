<template lang="">
  <section class="col-3-grid">
    ...
    >
      ...
      v-for="item in info4"
    :key="item">
        <img class="col-grid-3__block-grid-content-image" :src='item.urlToImage' :alt=' alt'>
...
mounted() {
  axios
    .get('https://newsapi.org/v2/top-headlines?category=health&language=en&apiKey=3b78f002dbc4466fb5314c295e5f268b&pageSize=12')
