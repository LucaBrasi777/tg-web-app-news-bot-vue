<template lang="">
    ...
    <div class="container-fluid" style="margin-top:10px">
        <div class="row">
            ...
            v-for="(item,index) in articles2.slice(40)"
                    :key="item"
            >
            ...
            <div class="col-lg-5 px-0">
                <div class="row mx-0">
                    ...
                    v-for="item in articles.slice(41)" :key="index">
          ...
          async getData() {
            ...
            try {
              const response = await fetch(
                `https://api-epicnews404.azurewebsites.net/Articles/TopHeadlines?SiteId=1&CategoryId=3&Language=14&WithImageOnly=true&Page=1&PageSize=${pageSize}`
              );
