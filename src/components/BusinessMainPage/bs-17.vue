<template lang="">
    ...
    :key="item"
    >
                        <!-- <div class="section-title mb-0  bg-info">
                           <h4 class="m-0 text-uppercase font-weight-bold text-white">Crypto</h4>
                       </div> -->
                       <div class="section-title mb-0 bg-black">
      <h4 class="m-0 text-uppercase font-weight-bold text-white animated-heading"><crypto/></h4>
    </div>
...
import crypto from '../../components/effectCrypto.vue'
export default {
  components:{stocks,crypto},
   data() {
      return {
        articles: [],       
        currentPage: 1,   
