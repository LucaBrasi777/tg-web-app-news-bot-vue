<template lang="">
  ...
  export default {
    data() {
        return {
          image:'https://imageio.forbes.com/specials-images/imageserve/652793e77333947df2b942eb/The-Impact-Of-Digital-Transformation-On-Business-Models--Opportunities-And-Challenges/960x0.jpg?format=jpg&width=960',
          articles: [],
          articles2: [], 
          currentPage: 1,    
          totalPages: 1,    
