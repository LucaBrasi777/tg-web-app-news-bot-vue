<template lang="">
  <h2><router-link class="route-link" to="/Entertainment">Entertainment</router-link></h2>
...
export default {
  ...
  mounted() {
    axios
      .get('https://newsapi.org/v2/top-headlines?category=entertainment&language=en&apiKey=2da18b40bc0a4763aea1b549e9ea7a4a&pageSize=8')
