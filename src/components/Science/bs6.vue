<!-- <template lang="">
  ...
  <br/>
    ...
    v-for="(item, index) in uniqueArticles" :key="index"
    >
    ...
    >
                                  ...
                                  <div class="w-100 h-100 px-3 d-flex flex-column justify-content-center  ">
                                      <div class="mb-2">
                                          <span class=" badge text-white badge-dark text-uppercase font-weight-semi-bold p-1 mr-2" >Medium</span>
     ...
     export default {
      ...
      try {
        const response = await fetch(
          ` https://api-epicnews404.azurewebsites.net/Articles?SiteId=1&Tags=science&Page=1&PageSize=${pageSize}`
        );
      ...
      <template lang="">
        <div class="mb-3 ">
          <div class="section-title mb-0">
            <h4 class="m-0 font-weight-bold">Science Articles</h4>
          </div>
          <div class="card-body">
          <div
         ...
         data() {
          ...
          methods: {
            ...
            async getData() {
              ...
              try {
                const response = await fetch(
                  `https://api-epicnews404.azurewebsites.net/Articles?SiteId=1&WithImageOnly=true&WithContentOnly=true&Tags=science&Page=1&PageSize=${pageSize}`
