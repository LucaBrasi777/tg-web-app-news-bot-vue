<template lang="">
            ...
            <div class="col-lg-12 px-0">
                <div class="row mx-0">
                    ...
                    v-for="(item, index) in articles.slice(4)" :key="index">
          ...
          async getData() {
            ...
            try {
              const response = await fetch(
                `https://api-epicnews404.azurewebsites.net/Articles/TopHeadlines?SiteId=6&CategoryId=3&Language=14&Page=2&PageSize=${pageSize}`
              );
