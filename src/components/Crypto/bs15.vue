           ...
           <div class="row mx-0">
               ...
               >
                   <div class="position-relative overflow-hidden" style="height: 250px;">
                     ...
                     <img class="img-fluid w-100 h-100" v-if="item.imageurl" :src="item.imageurl" style="object-fit: cover;">
 ...
 async getData() {
        ...
        async getData2() {
          ...
          try {
            const response = await fetch(
             // 'https://min-api.cryptocompare.com/data/v2/news/?categories=BTC,ETH&excludeCategories=Sponsored'
              'https://min-api.cryptocompare.com/data/v2/news/?categories=XRP,TRX,ADA,SOL,MATIC,&excludeCategories=Sponsored'
