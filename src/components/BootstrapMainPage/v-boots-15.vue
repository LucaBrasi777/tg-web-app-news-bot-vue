...
<main class="container mt-8">
  ...
  <div class="row row-cols-1 row-cols-md-4 g-4">
    ...
    <div class="col"
    v-for="(item, index) in articles.slice(8)" :key="index">
    <div class="card">
...
export default {
    data() {
        return {
          image:'https://themoney.co/wp-content/uploads/2022/03/Top-10-des-sports-les-plus-populaires-au-monde-en.jpg',
          articles: [],
          articles2: [], 
          currentPage: 1,   
          totalPages: 1,    
