<template lang="">
  ...
  <div class="container-fluid" style="margin-top:10px">
    ...
    <div class="row">
          ...
          v-for="(item, index) in articles2.slice(7)" :key="index"
          >
...
export default {
  data() {
      return {
       ...
       image2:'https://importanceoftechnology.net/wp-content/uploads/2020/05/Physiofusion-1024x819-2-950x760-1.jpg',
        articles: [],
        articles2: [],
        currentPage: 1,   
        totalPages: 1,    
