<template lang="">
    ...
    <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/vuCgzrbdqyA?si=me2TqX2Nq1OaQHfC" allowfullscreen></iframe>
      </div>
    </div>
  <div class="container-fluid mt-12">
        ...
        >
                                      ...
                                      <div class="w-100 h-100 px-3 d-flex flex-column justify-content-center  ">
                                          ...
                                          <a class="h6 m-0 text-center text-secondary text-uppercase font-weight-bold" :href="item.url" target="_blank" style="white-space: font-size:12px">
         ...
         import sc from '../articles2/artScience.vue'
         export default {
          components:{tags,sc},
             data() {
                 return {
