<template lang="">
  ...
  <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/sctwzsI1hH0?si=9KKediiEyw2NZ9iP" allowfullscreen></iframe>
    </div>
  </div>
<div class="container-fluid mt-12">
      ...
      >
       ...
       <script>
       import bus from '../articles2/artBus.vue'
       export default {
        components:{bus},
           data() {
               return {
             ...
             methods: {
                 ...
                 async getData() {
                   ...
                   try {
                    ...
                    ` https://api-epicnews404.azurewebsites.net/Articles?SiteId=1&Tags=health&Page=1&PageSize=${pageSize}`
                     );
