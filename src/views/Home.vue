     ...
     computed: {
      ...
      articles(){
        return [
        {
          ...
          {
            img:'https://image.myupchar.com/5303/original/swasthya-samachar-health-news-in-hindi.png',
            route:'/Health'
          },
          {
            img:'https://www.nimh.nih.gov/sites/default/files/images/landing-pages/science-news-article.jpg',
            route:'/Science'
          },
          {
